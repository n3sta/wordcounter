...
class ContentClass extends Component {
  ...
  render() {
    return (
      <ContentWrapper>
        <CounterWrapper>
          <CounterBar wordsLength={this.state.wordsLength} charactersLength={this.state.charactersLength} format={this.state.format} clear={this.handleClear} minify={this.handleMinify} />
